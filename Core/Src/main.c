...
//	if(htim == &htim1)counter_upper= __HAL_TIM_GetCounter(&htim1);
...
//		Mpuvalueslo(&Mp_data);
		...
		dribble();
		rotors(Rotors_flag);
		HAL_UART_Transmit_DMA(&huart5,sendbuffer,10);
...
//  		// encoder end
//  		//gargi start
////  		bno055_vector_t v = bno055_getVectorEuler(); // gives euler values in 3d
////  		printf("Heading: %.2f Roll: %.2f Pitch: %.2f\r\n", v.x, v.y, v.z);
////  		printf("hi\r\n");
//  		//gargi end
//  		//digitalRead start
////  		X = HAL_GPIO_ReadPin(GPIOC, GPIO_PIN_1);
//  		//digitalRead end
//  		//analogRead start
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_1|GPIO_PIN_12|GPIO_PIN_13|GPIO_PIN_4
